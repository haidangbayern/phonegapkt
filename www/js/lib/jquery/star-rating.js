...
(function ($) {
    ...
    window.first_load_caption = true;
    ...
    Rating.prototype = {
        ...
        fetchCaption: function (rating) {
            ...
            var cap = !isEmpty(self.starCaptions[val]) ? self.starCaptions[val] : self.defaultCaption;
        ...
        setStars: function () {
            ...
            if (window.first_load_caption){
              
                window.first_load_caption = false;
                var caption = self.defaultCaption;
            }
    ...
    $.fn.rating.defaults = {
        ...
        showClear: true,
        showCaption: true,
        defaultCaption: 'Rating this game!',
        starCaptions: {
            // 0.5: 'Half Star',
            1: 'It\'s awful!',
            // 1.5: 'One & Half Star',
